...
> **NOTE** - Some companies might ask **too much** for a take-home assignment, like developing a whole app with a documentation just to be considered for a role. This should raise suspicion as these companies might just want you to do some part of their job, without a pay, so please beware. 
