...
- **Tip:** - Usually you will have a lot of iterations of your resume it makes sense to do some version control on them. For example: you can put timestamp on your resume so that you won't accidentally send old resume. For example: `CV-2020-06-01.pdf`
...
In order to filter out applicants, some companies make take-home assignments or coding tests that you have to do in order to pass to the next stage. The tasks have time restrictions as well as deadlinesas, and they vary from company to company - from completing some simple test to building a small prototype. In my practice the most abundant type of take-home task was a coding test that had to be completed in 1-2 hours after starting. These coding tests usually consist of a couple of algorithmic questions along with a multiple-choice test. 

> **NOTE** - Sometimes, some companies might ask **too much** for a take-home assignment, like developing a whole app with a documentation just to be considered for a role. This should raise suspicion as these companies might just want you to do some part of their job, without a pay, so please beware. 

## Interviews

As a final stage of hiring process, companies make several rounds of interviews for their candidates. The interview processes vary from company to company, so it is better to do a research on what kind of interviews your desired company is doing. However, despite their differences, they more or less follow the same algorithm: 

- First several rounds (2-3) of interviews are **phone/online interviews**. You will be given a shared environment and you need a software to talk with your interviewer. For software engineering roles, like in coding tests you will be asked to solve problems related to algorithms and data structures. The difference between coding tests and interviews is that interviews are far more complicated by the fact that you have to explain your proposed solution to the interviewer while coding it. It is a skill in itself, and it is necessary to distinguish the ability to do interviewing and problem solving. 

- The final interview(s) is **onsite interview**, as you have to physically arrive to the office for it. It is quite exciting experience as you might go on an office tour. (especially if office is in another country) This time you might be asked to do an interview on a whiteboard, so be prepared to compile code in your head or draw a design of a scalable system. The major benefit from these interviews is that you will have an opportunity to talk face-to-face with your potential employer and a team.  
...
This is the list of useful resources to make job application process easier.
